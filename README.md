...
You'll need node 4.8.x and npm 2.15.x installed to run SoteTalent. The easiest way is to download the installers from [nodejs.org](http://nodejs.org).
...
When it's all up and running, you should see the message `SoteTalent is ready on port 3000` and you'll be able to browse the site on [localhost:3000](http://localhost:3000).
